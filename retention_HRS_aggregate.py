...
path_C10_3 = '/Users/Lab User/Documents/Memristor/Measurements/Retention/2022-10-12/FIB3_C10_3_low_drift_LP6dB6dBHz_Integ1.0_Bias-0.1V.csv'
df_a = pd.read_csv(path_C10_1)
df_b = pd.read_csv(path_C10_2)
df_c = pd.read_csv(path_C10_3)
...
ctime_c = datetime.fromtimestamp(os.path.getctime(path_C10_3))
diff_ab = (ctime_b - ctime_a).total_seconds()
diff_bc = (ctime_c - ctime_a).total_seconds()
...
plt.semilogy(time, res, marker = 'x', label = 'FIB3_C10')
